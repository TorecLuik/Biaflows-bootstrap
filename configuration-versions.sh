...
BIOFORMAT_VERSION=v2.1.0

IMS_NAMESPACE=cytomineuliege
IMS_VERSION=v2.0.0-rc.2

CORE_NAMESPACE=neubiaswg5
CORE_VERSION=v1.7.0

WEB_UI_NAMESPACE=neubiaswg5
WEB_UI_VERSION=v1.1.0
...
SOFTWAREROUTER_VERSION=v2.5.0

PROJECT_MIGRATOR_NAMESPACE=neubiaswg5
PROJECT_MIGRATOR_VERSION=v0.3